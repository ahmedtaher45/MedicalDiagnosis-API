...
{
    public class GetSystemNotificationsUseCase
    {
         private readonly IUnitOfWork _unitOfWork;
        public GetSystemNotificationsUseCase(IUnitOfWork unitOfWork)
        {
        ...
        {
            var notifications = await _unitOfWork.Notifications.GetUserSystemNotificationsAsync(userId);
